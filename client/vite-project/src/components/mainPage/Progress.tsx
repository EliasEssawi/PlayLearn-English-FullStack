    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white text-slate-900">
      <div className="max-w-6xl mx-auto px-5 py-8">
        ...
        <div className="flex flex-col gap-2 mb-6">
          ...
          <div className="mt-2 inline-flex items-center gap-2 text-sm px-3 py-2 rounded-xl bg-white border border-green-200 text-green-800">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 flex flex-col gap-5">
            {/* Filters Sidebar */}
            <div className="rounded-3xl border border-green-200 bg-white p-5 shadow-sm sticky top-4">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-extrabold text-green-900">Filters (Summary only)</h2>
                <button
                  onClick={resetFilters}
                  className="px-4 py-2 rounded-xl bg-green-600 text-white font-bold hover:opacity-90"
                >
                  Reset
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select
                    ...
                    className="px-4 py-3 rounded-xl bg-green-50 border border-green-200"
                  >
            ...
            <div className="rounded-3xl border border-green-200 bg-white p-5 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-extrabold text-green-900">📌 Filtered Summary</h2>
                {summaryLoading && <span className="text-sm text-slate-500">Loading...</span>}
              </div>

              {topicSummary.length === 0 ? (
                <div className="text-slate-500">No data for this filter.</div>
              ) : (
                    ...
                    <tbody>
                      {topicSummary.map((r, idx) => (
                        <tr key={idx} className="border-t border-green-100">
                          ...
                          <td className="py-2 font-extrabold text-green-700">{r.percent}%</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
